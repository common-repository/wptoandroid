...
class WTA_REST_Post_Statuses_Aux_WTA_Controller extends WTA_REST_Aux_WTA_Controller {
	...
	public function prepare_item_for_response( $status, $request ) {
		...
		if ( 'publish' === $status->name ) {
			$response->add_link( 'archives', rest_url( '/wp-android/posts' ) );
		} else {
			$response->add_link( 'archives', add_query_arg( 'status', $status->name, rest_url( '/wp-android/posts' ) ) );
		}

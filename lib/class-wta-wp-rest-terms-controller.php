 ...
 */
class WTA_REST_Terms_Aux_WTA_Controller extends WTA_REST_Aux_WTA_Controller {
	...
	protected function prepare_links( $term ) {
		...
		$links = array(
			...
			'about'      => array(
				'href'       => rest_url( sprintf( 'wp-android/taxonomies/%s', $this->taxonomy ) ),
			),
		);
		...
		foreach ( $taxonomy_obj->object_type as $type ) {
			...
			$post_type_links[] = array(
				'href' => add_query_arg( $this->rest_base, $term->term_id, rest_url( sprintf( 'wp-android/%s', $rest_base ) ) ),
			);
		}

...
class WTA_REST_Revisions_Aux_WTA_Controller extends WTA_REST_Aux_WTA_Controller {
	...
	public function __construct( $parent_post_type ) {
		...
		$this->parent_controller = new WTA_REST_Posts_Aux_WTA_Controller( $parent_post_type );
